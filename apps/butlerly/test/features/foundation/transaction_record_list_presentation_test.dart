...
void main() {
  testWidgets('shared transaction rows use merchant title and matching amount size', (
    tester,
  ) async {
  ...
  testWidgets('shared transaction rows fall back when merchant is unavailable', (
    tester,
  ) async {
    final now = DateTime.utc(2026, 9, 15, 12);
    final transaction = TransactionDto(
